...
window.__WORK__ = {
  title: "工作幸福度计算机",
  intro: "一张把'你这份班值不值'折算成数字的表。\n填下面这些 —— 工资、房租、加班、同事、通勤……拖着填,数字实时跳。\n大于 1,这班上得快乐;小于 1,你早该知道了。",
  ...
  groups: [
    ...
    { name: "时间(单位:小时)", fields: [
      ...
      ["fishHour", "摸鱼时长/天", 1, "num"],
      ["otWeekday", "工作日日均加班", 1, "num"],
      ["otWeekend", "周末加班(每周总和÷2)", 0, "num"],
      ["commute", "单程通勤时间", 0.75, "num"],
    ] },
    { name: "通勤方式", fields: [
    ...
    { name: "压力 & 环境(1-5 星)", fields: [
      ...
      ["coop", "同事合作星级", 3, "star"],
      ["health", "工作健康度(久坐看屏、椅子差就低)", 3, "star"],
      ["fun", "工作乐趣度", 3, "star"],
    ] },
